...
<address>
 ...
 <div class="alert alert-error alert-block hide">
             ...
             <div class="alert alert-success alert-block opacity-anim-hid">
...
<script>   
 ...
 <script src="https://maps.googleapis.com/maps/api/js?sensor=false"></script>
  ...
  <script src="//cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.10.0/jquery.validate.js"></script><script src='js/vendor/waypoints.min.js'></script>
...
Modernizr.load({
  ...
  nope: 'http://localhost/gitxamp/js/vendor/effects-css.js'
    ...
    $(this).delay(10).animate({opacity:1,bottom:"0px"},2000);
}, { offset: 900 });
		});
	</script>	
<script type="text/javascript">
               ...
               if (response == 'true')
                {
					...
					$('.alert-success').addClass("opacitydis");
					setTimeout(function(){
       $('.alert-success').addClass("opacity-anim-vis");
   }, 100);
					//$('.alert-success').addClass("opacity-anim-vis");
					
					//$('.alert-success').removeClass("hide").hide().fadeIn("slow");
...
scrollTarget: '.alert'
               ...
               if (response == 'false')
                {$('.alert-error').removeClass("hide").hide().fadeIn("slow");
                   $('.submit').button('reset')
                }
			   if (response == 'falsex')
                {$('.mailrr').removeClass("hide").hide().fadeIn("slow");
                   $('.submit').button('reset')
                }
